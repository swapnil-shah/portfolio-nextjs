...
export default function Hero() {
  return (
    <div className="static flex flex-col justify-between w-full p-8 md:max-w-lg lg:max-w-xl md:fixed md:h-screen lg:pb-20 lg:pt-48 lg:pl-20 md:pr-0">
      <div className="flex flex-col">
        <div>
          <h1 className="text-4xl font-bold leading-tight lg:text-7xl lg:leading-none">
            {hero.title}
          </h1>
        ...
        <nav className="text-sm font-bold uppercase text-widest hidden mt-16 md:block">
          <ul className="flex flex-row md:flex-col md:-my-4">
            {navItems.map((item, i) => (
              <li className="md:my-4 list-none">
                <Link href={item.path}>
                  {/* When active */}
